...
public class RequestLogger implements ContainerRequestFilter, ClientRequestFilter, ContainerResponseFilter,
	 ...
	 */
	public RequestLogger(Logger logger, boolean printEntity) {
		this.logger = logger;
	 ...
	 */
	public RequestLogger(Logger logger, int maxEntitySize) {
		this.logger = logger;
